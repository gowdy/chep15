...
56949 jobs were extracted from the dashboard, as run in February
2015. To provide a more even distribution of jobs across the
infrastucture each job was duplicated and ran at another site. For the
first scenario described in Section \ref{sec:today} the data was also
duplicated with the job.
